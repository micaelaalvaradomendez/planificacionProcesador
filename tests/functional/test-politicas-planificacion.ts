...
const procesosBasicos: ProcessSpec[] = [
  { id: 'P1', arribo: 0, rafagasCPU: 1, duracionCPU: 10, duracionIO: 0, prioridad: 3 },
  { id: 'P2', arribo: 2, rafagasCPU: 1, duracionCPU: 5, duracionIO: 0, prioridad: 1 },
  { id: 'P3', arribo: 4, rafagasCPU: 1, duracionCPU: 8, duracionIO: 0, prioridad: 2 },
  { id: 'P4', arribo: 6, rafagasCPU: 1, duracionCPU: 3, duracionIO: 0, prioridad: 4 }
];

// Procesos para probar Round Robin específicamente
const procesosRR: ProcessSpec[] = [
  { id: 'P1', arribo: 0, rafagasCPU: 1, duracionCPU: 12, duracionIO: 0, prioridad: 1 },
  { id: 'P2', arribo: 1, rafagasCPU: 1, duracionCPU: 8, duracionIO: 0, prioridad: 1 },
  { id: 'P3', arribo: 2, rafagasCPU: 1, duracionCPU: 4, duracionIO: 0, prioridad: 1 }
];
