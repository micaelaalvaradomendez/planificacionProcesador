...
import { servicioTotal, isProcesoValido, type Proceso } from '../model/proceso';
import { rafagaActual, quedanRafagas } from '../model/rafaga';
import { isTransicionLegal, assertTransicionLegal, transicionarEstado } from '../model/estados';
import { COSTOS_DEF, validarCostos, makeCostos } from '../model/costos';
